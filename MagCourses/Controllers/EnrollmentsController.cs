...
namespace MagCourses.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var enrollments = db.Enrollments.Include(e => e.Course).Include(e => e.Student).Include(e => e.Subject);
        ...
        public ActionResult Create([Bind(Include = "EnrollmentID,CourseID,SubjectID,StudentID,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentID,CourseID,SubjectID,StudentID,Grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
